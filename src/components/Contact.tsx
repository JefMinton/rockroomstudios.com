  ...
  return (
    <section id="contact" className="relative py-32 bg-card/30">
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        ...
        {/* Cal.com Booking Widget - Using secure iframe approach */}
        <div className="max-w-5xl mx-auto">
          <div className="bg-background clean-border rounded-3xl overflow-hidden elevated-shadow">
            ...
            {/* Cal.com Embed Container - Secure iframe instead of script injection */}
            <div className="p-0 bg-white">
              <iframe
                src="https://cal.com/mojli/30min?embed=true&layout=month_view"
                style={{
                  width: '100%',
                  height: '600px',
                  border: 'none'
                ...
                title="Book a discovery call with MOJJU"
                loading="lazy"
              />
            </div>
          </div>
